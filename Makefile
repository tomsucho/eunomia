...
LDFLAG_LOCATION=github.com/KohlsTechnology/eunomia/version
LDFLAGS := "-X ${LDFLAG_LOCATION}.Branch=${BRANCH} -X ${LDFLAG_LOCATION}.BuildDate=${DATE} \
	-X ${LDFLAG_LOCATION}.GitSHA1=${COMMIT}"
